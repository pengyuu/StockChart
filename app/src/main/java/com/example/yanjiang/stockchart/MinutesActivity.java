...
//                barChart.setHighlightValue(new Highlight(h.getXIndex(), 0));
                ...
                barChart.highlightValue(new Highlight(h.getX(),h.getY(), 0));
        ...
        barChart.setOnChartValueSelectedListener(new OnChartValueSelectedListener() {
            @Override
            public void onValueSelected(Entry e, Highlight h) {
                lineChart.highlightValue(new Highlight(h.getX(),h.getY(), 0));
    ...
    private void initChart() {
        ...
        //bar x y轴
        xAxisBar = (MyXAxis) barChart.getXAxis();
        ...
        axisRightBar = (MyYAxis) barChart.getAxisRight();
    ...
    private void setData(DataParse mData) {
        ...
        axisLeftBar.setAxisMaximum(mData.getVolmax());
        /*单位*/
        ...
        /*次方*/
        axisLeftBar.setValueFormatter(new DefaultAxisValueFormatter((int) Math.pow(10, u)));
        axisLeftBar.setShowMaxAndUnit(unit);
        axisLeftBar.setDrawLabels(true);
        //axisLeftBar.setAxisMinValue(0);//即使最小是不是0，也无碍
        axisRightBar.setAxisMaximum(mData.getVolmax());
